...
// node_modules/screenshot-desktop/lib/utils.js
var require_utils = __commonJS({
  "node_modules/screenshot-desktop/lib/utils.js"(exports2, module2) {
    var fs2 = require("fs");
...
// node_modules/screenshot-desktop/lib/linux/index.js
var require_linux = __commonJS({
  "node_modules/screenshot-desktop/lib/linux/index.js"(exports2, module2) {
    var exec = require("child_process").exec;
    var path2 = require("path");
    var defaultAll = require_utils().defaultAll;
    var EXAMPLE_DISPLAYS_OUTPUT = `Screen 0: minimum 320 x 200, current 5760 x 1080, maximum 8192 x 8192
...
// node_modules/rimraf/node_modules/brace-expansion/index.js
var require_brace_expansion = __commonJS({
  "node_modules/rimraf/node_modules/brace-expansion/index.js"(exports2, module2) {
...
var require_temp = __commonJS({
  "node_modules/temp/lib/temp.js"(exports2, module2) {
    var fs2 = require("fs");
    var path2 = require("path");
    ...
    var dir = path2.resolve(os2.tmpdir());
    ...
    var createWriteStream = (affixes) => {
      ...
      let stream4 = fs2.createWriteStream(path3, { flags: RDWR_EXCL, mode: 384 });
      deleteFileOnExit(path3);
      return stream4;
    };
    exports2.dir = dir;
...
// node_modules/screenshot-desktop/lib/darwin/index.js
var require_darwin = __commonJS({
  "node_modules/screenshot-desktop/lib/darwin/index.js"(exports2, module2) {
    var exec = require("child_process").exec;
    var temp = require_temp();
    var fs2 = require("fs");
    var utils = require_utils();
    var path2 = require("path");
    var { unlinkP, readAndUnlinkP } = utils;
    function darwinSnapshot(options = {}) {
      const performScreenCapture = (displays) => new Promise((resolve, reject) => {
        ...
        const tmpPaths = Array(displayId + 1).fill(null).map(() => temp.path({ suffix }));
        let pathsToUse = [];
        if (options.filename) {
...
`;
    ...
    function parseDisplaysOutput(output) {
      ...
      firstGpuKeys.forEach((gpukey) => {
        ...
        if (gpu.Displays) {
          const temp2 = Object.entries(gpu.Displays).map(([name, props]) => {
            const primary = props["Main Display"] === "Yes";
            return { name, primary };
          });
          displayinfos = displayinfos.concat(temp2);
        }
      });
    ...
    darwinSnapshot.all = all3;
    darwinSnapshot.parseDisplaysOutput = parseDisplaysOutput;
    darwinSnapshot.EXAMPLE_DISPLAYS_OUTPUT = EXAMPLE_DISPLAYS_OUTPUT;
    module2.exports = darwinSnapshot;
  }
});

// node_modules/screenshot-desktop/lib/win32/index.js
var require_win32 = __commonJS({
  "node_modules/screenshot-desktop/lib/win32/index.js"(exports2, module2) {
    var exec = require("child_process").exec;
    var temp = require_temp();
    var path2 = require("path");
    var utils = require_utils();
    ...
    module2.exports = windowsSnapshot;
  }
});

// node_modules/screenshot-desktop/index.js
var require_screenshot_desktop = __commonJS({
  "node_modules/screenshot-desktop/index.js"(exports2, module2) {
    "strict mode";
    if (process.platform === "linux") {
      ...
      module2.exports = function unSupported() {
...
var require_constructor = __commonJS({
  "node_modules/sharp/lib/constructor.js"(exports2, module2) {
    ...
    Object.setPrototypeOf(Sharp.prototype, stream4.Duplex.prototype);
    Object.setPrototypeOf(Sharp, stream4.Duplex);
    function clone() {
...
var require_python_shell = __commonJS({
  "node_modules/python-shell/index.js"(exports2) {
    "use strict";
    ...
    exports2.PythonShell = exports2.NewlineTransformer = exports2.PythonShellErrorWithLogs = exports2.PythonShellError = void 0;
    ...
    exports2.PythonShellError = PythonShellError;
    var PythonShellErrorWithLogs = class extends PythonShellError {
    };
    exports2.PythonShellErrorWithLogs = PythonShellErrorWithLogs;
    ...
    exports2.NewlineTransformer = NewlineTransformer;
    var PythonShell2 = class _PythonShell extends events_1.EventEmitter {
      /**
      ...
      constructor(scriptPath, options, stdoutSplitter = null, stderrSplitter = null) {
        ...
        options = extend2({}, _PythonShell.defaultOptions, options);
        let pythonPath;
        if (!options.pythonPath) {
          pythonPath = _PythonShell.defaultPythonPath;
        } else
          pythonPath = options.pythonPath;
        let pythonOptions = toArray2(options.pythonOptions);
        let scriptArgs = toArray2(options.args);
      ...
      static run(scriptPath, options) {
        return new Promise((resolve, reject) => {
          let pyshell = new _PythonShell(scriptPath, options);
          let output = [];
      ...
      static runString(code, options) {
        ...
        return _PythonShell.run(filePath, options);
      }
    ...
    exports2.PythonShell = PythonShell2;
...
var import_screenshot_desktop = __toESM(require_screenshot_desktop());
...
// src/extension.ts
var { PythonShell } = require_python_shell();
function activate(context) {
  ...
  const disposable = vscode.commands.registerCommand("extension.captureTerminalScreenshot", async () => {
    ...
    try {
      const imageBuffer = await (0, import_screenshot_desktop.default)();
      vscode.window.showInformationMessage("\u{1F4F8} Screenshot captured successfully.");
      const image = (0, import_sharp.default)(imageBuffer);
      ...
      const croppedImageBuffer = await (0, import_sharp.default)(imageBuffer).extract({ left: validX, top: validY, width: validWidth, height: validHeight }).toBuffer();
      console.log("\u{1F4F8} Cropped screenshot to the defined region.");
      const distDir = "/Users/apple/Desktop/extension/terminal-error-solution/dist";
      if (!fs.existsSync(distDir)) {
        fs.mkdirSync(distDir, { recursive: true });
      }
      const tempImagePath = path.join(distDir, "temp_image.png");
      fs.writeFileSync(tempImagePath, croppedImageBuffer);
      console.log(`\u{1F4F8} Image saved to: ${tempImagePath}`);
      const extractedText = await runOCR(tempImagePath);
      console.log("\u{1F9E0} Extracted Text:", extractedText);
      if (extractedText) {
        vscode.window.showInformationMessage(`\u{1F4DD} OCR Extracted Text:
${extractedText.slice(0, 200)}...`);
      ...
      try {
        ...
        vscode.window.showInformationMessage(`\u{1F4A1} GPT Suggestion:
${finalMsg}`);
      } catch (err) {
...
async function runOCR(imagePath) {
  return new Promise((resolve, reject) => {
    ...
    const shell = new PythonShell(scriptPath, {
      pythonPath: "/Users/apple/.pyenv/shims/python3",
      pythonOptions: ["-u"],
      args: [imagePath],
      timeout: 6e4
...
async function fetchGPTSolution(errorMessage) {
...
${errorMessage}` }
    ...
    console.log("\u{1F9E0} GPT Response:", gptReply);
